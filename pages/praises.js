...
const Praises = ({ records }) => {
    ...
    return (
        <Layout title="Praises">
            <h1 className="primary-font text-center">Praises</h1>
            {praises &&
                praises.length > 0 &&
                praises.map((q, i) => {
                    return (
                        <div className="card m-2" key={i}>
                            <div className="card-body">
                                ...
                                <small className="card-text primary-font ">
            ...
            {(!praises || praises.length == 0) && (
                <p className="primary-font text-center">Please contact me if you would like to leave a review</p>
            )}
        </Layout>
    );
};
